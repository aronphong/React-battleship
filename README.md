...
* Managing state and having separate component logic
* Learning how to structure components to maximize reuseability 

## Things to do
* Create display for winner
* 2 Human Player ability
* Styling
